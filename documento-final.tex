...
\FunctionTok{font\_add\_google}\NormalTok{(}\AttributeTok{name=}\StringTok{"Noto Sans"}\NormalTok{, }\AttributeTok{family =} \StringTok{"noto"}\NormalTok{)}
\FunctionTok{theme\_set}\NormalTok{(}\FunctionTok{theme\_bw}\NormalTok{(}\AttributeTok{base\_family =} \StringTok{"noto"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
